...
import 'package:zalada_app/features/cart/manager/logic/showproducts/products_show_cubit.dart'
    hide ProductsShowCubit;
  ...
  static List<Widget> boyWidgets = [
    ...
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) =>
              ProductsShowCubit(RepoCartImpl(apiService: ApiService(Dio())))
                ..fetchAllProducts(),
        ),
      ],
