  ...
  Widget build(BuildContext context) {
    return Center(
      child: Row(
        ...
        children: [
          SlideTransition(position: slideAnimation, child: Text("App",style: AppTextStyles.textStyle16.copyWith(
          ...
          SlideTransition(
            ...
            child: Text("Restaurant",style: AppTextStyles.textStyle24.copyWith(
              color: AppColor.white,
            ),),
          ),
        ],
